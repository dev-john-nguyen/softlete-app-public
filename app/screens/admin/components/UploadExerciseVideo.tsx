...
const UploadExerciseVideo = ({
  ...
  const onNavToExerciseEdit = () => {
    setUri('');
    route.params && route.params.admin
      ? navigation.navigate(AdminStackList.AdminEditExercise)
      : navigation.navigate(HomeStackScreens.EditExercise);
  };
...
const mapDispatchToProps = (dispatch: any) => ({
  removeExercise: (exericseUid?: string) =>
    dispatch(removeExercise(exericseUid, true)),
  dispatch,
});
