...
function SettingsStack(parentProps: any) {
    return (
        <Tab.Navigator screenOptions={(childProps) => screenOptions(parentProps, childProps)}>
            ...
            <Tab.Screen name="FormInput" component={FormInput} options={{
                headerTitle: '',
                headerRight: () => null,
                headerLeft: () => null
            }}
            ...
            <Tab.Screen name='RemoveAccount' component={RemoveAccount} options={{
                headerTitle: '',
                headerRight: () => null,
                headerTransparent: true
            }} />

            <Tab.Screen name='BugReport' component={BugReport} options={{
                headerTitle: '',
                headerRight: () => null,
                headerTransparent: true
            }} />
            ...
            <Tab.Screen name='Legal' component={Legal} options={{
                headerTitle: '',
                headerRight: () => null,
                headerTransparent: true
            }} />
