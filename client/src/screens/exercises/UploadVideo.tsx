...
const UploadExerciseVideo = ({ navigation, dispatch, route, exerciseProps, removeExercise, user }: Props) => {
    ...
    const onNavToExerciseEdit = () => {
        ...
        if (route && route.params) {
            ...
            if (route.params.programStack) {
                return navigation.navigate(ProgramStackScreens.ProgramEditExerciseDetails)
            }
        }
...
const mapDispatchToProps = (dispatch: any) => ({
    removeExercise: (exericseUid?: string) => dispatch(removeExercise(exericseUid)),
    dispatch
})
