...
import { ExerciseActionProps, Categories, ExerciseProps } from '../../services/exercises/types';
...
const EditExerciseDetails = ({ route, navigation, removeExercise, findExercise, user, exerciseProps, dispatch }: Props) => {
    ...
    useEffect(() => {
        ...
        if (!(exerciseProps.userUid === user.uid || (exerciseProps.softlete && user.admin || !exerciseProps._id))) {
    ...
    return (
        <SafeAreaView style={styles.container} edges={['bottom', 'left', 'right']}>
            ...
            <View style={{ paddingLeft: StyleConstants.baseMargin, paddingRight: StyleConstants.baseMargin }}>
                ...
                <View>
                    ...
                    <Pressable style={[styles.itemContainer, { backgroundColor: isOwner ? BaseColors.white : BaseColors.lightWhite }]} onPress={onCatPress}>
                ...
                <PrimaryButton onPress={onSubmit} styles={styles.btn}>Next</PrimaryButton>
...
const mapDispatchToProps = (dispatch: any) => ({
    removeExercise: async (_id?: string, admin?: boolean) => dispatch(removeExercise(_id, admin)),
    findExercise: async (name: string) => dispatch(findExercise(name)),
    dispatch
})

export default connect(mapStateToProps, mapDispatchToProps)(EditExerciseDetails);