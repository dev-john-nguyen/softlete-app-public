...
const FormInput = ({ route, navigation }: Props) => {
    ...
    const onNavigateBack = () => {
        if (!route || !route.params || !route.params.goBackScreen) return navigation.goBack();
    ...
    useEffect(() => {
        ...
        const { value: paramsValue, des: paramsDes, mult: paramsMult, maxLength: paramsMaxLength } = route.params;
        setMult(paramsMult)
